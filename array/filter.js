...
// Como implementar nosso proprio Filter
var watchList = [
    {
      "Title": "Inception",
      "Year": "2010",
  ...
  Array.prototype.myFilter = function(callback) {
    ...
    // se o valor retornado pela função de callback for true ela adiciona o elemento no array
  ...
  var new_s = watchList.myFilter(function(watch) {
    return watch.imdbRating > 7;
  });
